...
from app.dependencies import get_cache_manager, get_model_manager, get_search_graph
...
async def research_deep_dive(
    ...
    """
    try:
        # Initialize multi-agent orchestrator with SearchGraph for web search capabilities
        orchestrator = MultiAgentOrchestrator(model_manager, cache_manager, search_graph)
